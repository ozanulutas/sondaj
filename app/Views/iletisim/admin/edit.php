...
<form method="post" action="" enctype="multipart/form-data"  class="col-xl-9">
    ...
    <div class="form-group">
        ...
        <?php if(! empty($iletisim->parallax)) : ?>
        <div class="row">
            <div class="col-3 mb-1 text-center">
                <img src="<?= IMAGE_PATH . $iletisim->parallax ?>" class="mt-2 img-thumbnail">
                <a href="/admin/Iletisim/resimKaldir/parallax" class="text-danger" onclick="return confirm('Resmi kaldırmak istediğinize emin misiniz?')">Resmi Kaldır</a>
            </div>
        </div>
        <?php endif; ?>
    </div>
